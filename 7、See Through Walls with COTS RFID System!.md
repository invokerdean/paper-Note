...
在这项工作中，我们把注意力转向成熟的RFID技术。 RFID正在成为全球识别和跟踪物体的主要技术推动者。这种广泛部署的原因是标签的简单性，这使得在大容量时丢失率很低。 RFID系统的好处之一是可以识别物体而不需要视线（LOS）由于多径效应。这个具有挑战性的问题是“RFID系统能否使我们识别和跟踪墙壁上的物体？”。在第一个本能，这似乎是一个不可能的任务，因为标签背散射信号太弱（通常在-55 dBm）穿越墙（衰减〜18 dB），甚至厚玻璃（衰减〜3dB） [16]。
